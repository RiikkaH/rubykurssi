...
describe "beerlist page" do
  ...
  it "shows beers sorted by the name", js: true do
    visit beerlist_path
  ...
  it "shows beers sorted by style when clicked link style", js: true do
    visit beerlist_path
  ...
  it "shows beers sorted by brewery when clicked link brewery", js: true do
    visit beerlist_path
    find('table').find('tr:nth-child(2)')
    click_link("brewery")
